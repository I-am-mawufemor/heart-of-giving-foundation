...
@section('admin-content')
    <section id="form-container">
        <a href="/UpcomingEvent" class="fa fa-arrow-left" aria-hidden="true"></a>
        <h1>Create Upcoming Event Post</h1>

        {{-- <div id="form-container"> --}}
        <form action="{{ route('upcomingEvent.store') }}" method="POST" enctype="multipart/form-data">
