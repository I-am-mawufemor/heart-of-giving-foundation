            ...
            <div class="form-group">
                ...
                <div class="">
                    <input type="text" id="facebook" class="form-control @error('facebook') is-invalid @enderror"
                        name="facebook" value="{{ old('facebook') }}" required autocomplete="facebook" autofocus>
                    @error('facebook')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="form-group">
                ...
                <div class="">
                    <input type="text" id="twitter" class="form-control @error('twitter') is-invalid @enderror"
                        name="twitter" value="{{ old('twitter') }}" required autocomplete="twitter" autofocus>
                    @error('twitter')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="form-group">
                ...
                <div class="">
                    <input type="text" id="whatsApp" class="form-control @error('whatsApp') is-invalid @enderror"
                        name="whatsApp" value="{{ old('whatsApp') }}" required autocomplete="sub_heading_3" autofocus>
                    @error('whatsApp')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="form-group">
                ...
                <div class="">
                    <input type="text" id="" class="form-control @error('linkdin') is-invalid @enderror"
                        name="linkdin" value="{{ old('linkdin') }}" required autocomplete="linkdin" autofocus>
                    @error('linkdin')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
