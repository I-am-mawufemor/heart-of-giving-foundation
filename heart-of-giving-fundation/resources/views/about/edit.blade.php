            ...
            <div class="form-group">
                ...
                <div class="">
                    <input type="text" id="sub_heading_1"
                        ...
                        value="{{ $post->sub_heading_1 }}" required autocomplete="sub_heading_1" autofocus>
                    @error('sub_heading_1')
            ...
            <div class="form-group">
                ...
                <div class="">
                    <input type="text" id="sub_heading_2"
                        ...
                        value="{{ $post->sub_heading_2 }}" required autocomplete="sub_heading_2" autofocus>
                    @error('sub_heading_2')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="form-group">
                ...
                <div class="">
                    <input type="text" id="sub_heading_3"
                        ...
                        value="{{ $post->sub_heading_3 }}" required autocomplete="sub_heading_3" autofocus>
                    @error('sub_heading_3')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="form-group">
                ...
                <div class="">
                    <input type="text" id="sub_heading_4"
                        ...
                        value="{{ $post->sub_heading_4 }}" required autocomplete="sub_heading_4" autofocus>
                    @error('sub_heading_4')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
