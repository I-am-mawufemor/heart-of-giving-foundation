...
class HomeEventController extends Controller
{
    ...
    {
        //fetch data
        $post = HomeEvent::orderBy('created_at', 'desc')->paginate(10);
        return view('home-event.index')->with('post', $post);
    }
    ...
    {
        //
        $post = HomeEvent::find($id);
        return view('home-event.show')->with('post', $post);
    }
    ...
    public function edit(string $id)
    {
        //
        $post = HomeEvent::find($id);
        return view('home-event.edit')->with('post', $post);
    }
    ...
    public function destroy(string $id)
    {
        ...
        $post->delete();
        return redirect('/homeEvent')->with('success', 'Post deleted successfully');
    }
}
